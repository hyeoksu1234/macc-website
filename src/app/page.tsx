...
export default function Home() {
  ...
  const heroImages = [
    {
      id: 1,
      url: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=3840&auto=format&fit=crop&ixlib=rb-4.0.3",
      alt: "도전과 성장을 향한 여정"
    }
  ];
  ...
  return (
    <div className="flex flex-col">
      {/* 히어로 섹션 - 모바일 최적화 */}
      <section className="relative w-full h-[60vh] md:h-[80vh] lg:h-[90vh] flex items-center">
        ...
        <div className="container mx-auto px-4 z-10 text-white">
          <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-4 break-keep">
            Masterpiece Alliance
          </h1>
          <p className="text-base sm:text-lg md:text-2xl mb-6 md:mb-8 max-w-3xl break-keep">
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-6 break-keep">Our Philosophy</h2>
                ...
                >
                  ...
                  <div className="text-center">
                    <div className="mb-3 md:mb-4 lg:mb-6">
                      <span className="text-xl sm:text-2xl md:text-3xl font-bold text-[#0061ad] group-hover:text-[#f9ce00] transition-colors duration-300">Be</span>
                      <span className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 break-keep">{text.suffix}</span>
                    </div>
                    <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed break-keep">
                      {text.description}
                    </p>
                  </div>
                </div>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 break-keep">
              전문 서비스
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto break-keep">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
            {services.map((service, index) => (
              <Link
                ...
                className="group relative overflow-hidden bg-white rounded-lg sm:rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
              >
                {/* 그라디언트 배경 */}
                ...
                {/* 콘텐츠 */}
                <div className="relative z-10 p-4 sm:p-5 md:p-6 h-full flex flex-col justify-between text-white">
                  <div>
                    {/* 아이콘 - 모바일에서 작게 */}
                    ...
                    {/* 설명 (주석처럼) - 모바일에서 숨김 가능 */}
                    <p className="text-xs sm:text-sm opacity-90 leading-relaxed break-keep mb-0 hidden sm:block">
                      {service.description}
                    </p>
                    
                    {/* 제목 - 모바일에서 작게 */}
                    <h3 className="text-sm sm:text-base md:text-xl font-bold break-keep group-hover:scale-105 transition-transform duration-300">
                      {service.title}
                    </h3>
                  </div>
                  
                  {/* 화살표 아이콘 - 모바일에서 숨김 */}
                  <div className="mt-4 md:mt-6 flex justify-end hidden sm:flex">
                    <svg 
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 break-keep">고객의 목소리</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto break-keep">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              <div key={index} className="bg-white p-5 sm:p-6 md:p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex mb-3 md:mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <svg key={i} className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-400" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.62L12 2L9.19 8.62L2 9.24L7.46 13.97L5.82 21L12 17.27Z" />
                    </svg>
                  ))}
                </div>
                <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6 italic break-keep">"{testimonial.content}"</p>
                <div>
                  <p className="font-semibold text-gray-900 text-sm sm:text-base break-keep">{testimonial.name}</p>
                  <p className="text-xs sm:text-sm text-gray-600 break-keep">{testimonial.company}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* CTA 섹션 - 모바일 최적화 */}
      <section className="py-12 sm:py-16 md:py-24 bg-[#0061ad] text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 break-keep">
            성장의 여정을 함께 시작하세요
          </h2>
          <p className="text-base sm:text-lg md:text-xl mb-6 md:mb-8 max-w-3xl mx-auto break-keep">

  ...
  const services: Service[] = [
    {
      ...
      highlightText: "퇴직 후의 삶이 막연하신가요? 과연 방법이 없을까요?",
      detailedDescription: "100세 시대의 평균 퇴직 연령은 49.3세입니다. 퇴직 후의 삶, 잘 준비하고 계신가요? 코칭과 컨설팅을 기반으로 퇴직 후의 막연한 삶에 대한 걱정, 창업, 재취업 등 계획부터 실행까지 실질적인 도움을 드립니다. 코칭 기반 퇴직 준비서 <빨리 은퇴하라> 저자 코치와 다양한 분야의 전문가가 함께합니다.",
      subtitle: "지금까지 살아온 삶이 헛되지 않도록 앞으로 살 삶에서는 진정한 주인공으로 우뚝 설 수 있도록 안내하고 함께 가는 동반자가 되겠습니다.",
      features: [
        "퇴직 후 주인공으로 살기 위한 코칭 기반 자기 인식",

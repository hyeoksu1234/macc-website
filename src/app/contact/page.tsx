    ...
    <div className="flex flex-col">
      ...
      <section className="relative w-full h-[25vh] sm:h-[30vh] md:h-[40vh] flex items-center bg-gradient-to-r from-[#0061ad] to-[#004d8a]">
        <div className="container mx-auto px-4 z-10 text-white">
          ...
          <p className="text-sm sm:text-lg md:text-2xl max-w-3xl break-keep">
            Masterpiece Alliance의 코칭 및 컨설팅 서비스가 궁금하신가요? <br className="hidden sm:block" />
            지금 바로 연락하세요.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
              ...
              <div className="lg:pr-8">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 break-keep">성장의 첫 걸음을 내딛으세요</h2>
                <div className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed space-y-4 sm:space-y-6 mb-8 sm:mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                  {[
                    ...
                    <div key={index} className="flex items-center">
                      ...
                      <span className="text-base sm:text-lg font-semibold text-gray-800 break-keep">{feature}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
                <div className="text-center mb-6 sm:mb-8">
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 break-keep">무료 상담 신청</h3>
